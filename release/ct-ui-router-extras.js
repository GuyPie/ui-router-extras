...
//define(['angularAMD'], function (angularAMD) {
    angular.module('ct.ui.router.extras').provider('$futureState', ['$stateProvider', '$urlRouterProvider', function($stateProvider, $urlRouterProvider) {
        ...
        function futureState_otherwise($injector, $location) {
            ...
            var lazyLoadMissingState = ['$rootScope', '$urlRouter', '$state', function($rootScope, $urlRouter, $state) {
                if (!initDone) {
        ...
        this.$get = ['$injector', '$state', '$q', '$rootScope', '$urlRouter', '$log', function($injector, $state, $q, $rootScope, $urlRouter, $log) {
            function init() {
